...
- **v0.4** — received payments on sales invoices (`create_payment`
  `direction: "received"`) and sales-invoice processing into the accounting.
- **v0.5** (planned) — more write tools (ledgers, products, cost centers) and
